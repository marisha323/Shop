        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img class="d-block w-100" src="{{ asset('images/baner2.png') }}" alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="{{ asset('images/baner2.png') }}" alt="Third slide">
                </div>
            </div>
...
{{--                <div class="slider">--}}
{{--                    <img class="slide product_img_slider active" src="/images/baner2.png" alt="Shoe Icon">--}}
{{--                    <img class="slide product_img_slider" src="/images/baner1.png" alt="Shoe Icon">--}}
{{--                    <img class="slide product_img_slider" src="/images/baner3.png" alt="Shoe Icon">--}}
{{--                    <img class="slide product_img_slider" src="/images/baner4.png" alt="Shoe Icon">--}}
{{--                    <img class="slide product_img_slider" src="/images/baner5.png" alt="Shoe Icon">--}}
{{--                </div>--}}
