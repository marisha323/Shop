...
@if (Route::has('login'))
        ...
        <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10 flex items-center">
            ...
            <a href="{{ route('admin.index') }}"
               class="bg-white m-2 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 mr-4">
                ADMIN PANEL
            </a>
                                ...
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="product-images">
                                            @foreach ($product->images as $image) <!-- Здесь нужно использовать $product вместо $products -->
